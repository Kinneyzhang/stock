...
- Emacs 28.1+
- [[https://github.com/Kinneyzhang/tp][tp.el]] - Text Properties manipulation library

* Installation

Download =stock.el= and =stock-utils.el= to your Emacs load-path.
Make sure [[https://github.com/Kinneyzhang/tp][tp.el]] is installed.
...
- [[./docs/USER-GUIDE.org][用户使用指南 (User Guide)]] - Comprehensive user documentation in Chinese
- [[./docs/DESIGN.org][设计文档 (Design Doc)]] - Developer documentation for extending the package
