...
| stock-modeline-refresh-seconds  | 1                                      | integer | Seconds between mode-line refresh.                                                      |
| stock-modeline-format           | "[%n:%p]"                              | string  | Format string for each stock in mode-line. %n=name, %p=change percent.                  |
| stock-headerline-stocks         | nil                                    | list    | List of stock codes to display in header-line.                                          |
| stock-headerline-refresh-seconds| 1                                      | integer | Seconds between header-line refresh.                                                    |
| stock-headerline-format         | "[%n:%p]"                              | string  | Format string for each stock in header-line. %n=name, %p=change percent.                |
...
| stock-headerline-mode    | Toggle stock price display in header-line.           |
| stock-headerline-add     | Add stocks to header-line display.                   |
| stock-headerline-remove  | Remove a stock from header-line display.             |
...
* Header-line Display
You can display real-time stock price changes directly in the header-line.

#+BEGIN_SRC lisp
  ;; Configure stocks to show in header-line
