...
| stock-tabline-stocks     | nil                                     | list    | List of stock codes to display in tab-line.                                             |
| stock-tabline-format     | " [%n:%p] "                             | string  | Format string for each stock in tab-line. %n=name, %p=change percent.                   |
| stock-tabline-refresh-seconds | 10                                 | integer | Seconds between tab-line refresh.                                                       |
...
| stock-tabline-mode     | Toggle stock price display in tab-line.              |
| stock-tabline-add      | Add stocks to tab-line display.                      |
| stock-tabline-remove   | Remove a stock from tab-line display.                |
...
* Tab-line Display
You can display real-time stock price changes in the tab-line.

#+BEGIN_SRC lisp
  ;; Configure stocks to show in tab-line
  (setq stock-tabline-stocks '("sh600036" "sz000625"))
  
  ;; Enable tab-line display
  (stock-tabline-mode 1)
#+END_SRC
